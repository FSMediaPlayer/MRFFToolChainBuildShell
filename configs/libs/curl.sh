...
export LIB_NAME='curl'
export LIPO_LIBS="libcurl"
export LIB_DEPENDS_BIN="automake autoconf libtool"
export GIT_LOCAL_REPO=build/extra/curl
export GIT_COMMIT=curl-8_9_1
export REPO_DIR=curl
export GIT_REPO_VERSION=8.9.1
export PRE_COMPILE_TAG=curl-8_9_1
...
if [[ "$GIT_OPUS_UPSTREAM" != "" ]] ;then
    ...
    export GIT_UPSTREAM=https://github.com/curl/curl.git
fi