...
export LIB_NAME='cares'
export LIPO_LIBS="libcares"
export LIB_DEPENDS_BIN="automake autoconf libtool"
export GIT_LOCAL_REPO=build/extra/cares
export GIT_COMMIT=v1.33.0
export REPO_DIR=cares
export GIT_REPO_VERSION=1.33
export PRE_COMPILE_TAG=v1.33.0
...
if [[ "$GIT_OPUS_UPSTREAM" != "" ]] ;then
    ...
    export GIT_UPSTREAM=https://github.com/c-ares/c-ares.git
fi